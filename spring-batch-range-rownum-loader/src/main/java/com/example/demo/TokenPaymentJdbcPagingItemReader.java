...
public class TokenPaymentJdbcPagingItemReader extends JdbcPagingItemReader<TokenPayment> implements StepExecutionListener{

	private static final Logger LOG = LoggerFactory.getLogger(TokenPaymentJdbcPagingItemReader.class);

	private StepExecution stepExecution;


	public TokenPaymentJdbcPagingItemReader(DataSource dataSource, int pageSize, String queryProviderSelect,
	...
	public PagingQueryProvider queryProvider(DataSource dataSource, String queryProviderSelect,
		 ...
		 provider.setWhereClause(queryProviderWhere);
